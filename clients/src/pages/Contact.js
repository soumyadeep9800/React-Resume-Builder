      ...
      <div className='contact_map_head'>
        ...
        <div className='contact_address'>
            <div className='contact_address1'>
                ...
                <div className='contact_address3'>Bongaon,West Bengal,PIN-743235</div>
            </div>
...
<div className='From_contact_us'>
    <div className='From_contact_us_left'>
       <textarea type='text' className='From_contact_your' placeholder='Your Message' ></textarea>
    </div>
    <div className='From_contact_us_right'>
        <div className='From_contact_your_name'>
            <input className='From_contact_your_name2' placeholder='Name'></input>
        </div>
        <div className='From_contact_your_email'>
            <input className='From_contact_your_email2' placeholder='E-Mail Address'></input>
        </div>
        <div className='From_contact_your_button'><button className='From_contact_your_button2'>Submit</button></div>
    </div>
</div>
</div>
</div>
