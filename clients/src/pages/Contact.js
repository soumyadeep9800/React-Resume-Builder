...
export default function Contact() {
  const googleMapSrc =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3672.1766443915435!2d88.81054759999999!3d23.0172855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ff35b7a96e917d%3A0x6e8f298d5967f822!2sBongaon%20Kalupur.%20West%20Bengal!5e0!3m2!1sen!2sin!4v1742133973597!5m2!1sen!2sin";
    ...
    <>
      <div className="contact_us_main">
          ...
          <div className="contact_map_head">
            ...
            <div className="contact_address">
              <div className="contact_address1">
                ...
                <div className="contact_address3">
                  Bangaon,West Bengal,PIN-743235
                </div>
              </div>
              ...
              <div className="contact_address_link_main">
                <div className="contact_address_link">
                  <a
                    href="https://www.facebook.com/soumya.ghosh.33865"
                    target="_blank"
                    rel="noreferrer"
                    title="Facebook"
                  >
                ...
                <div className="contact_address_link">
                  <a
                    href="https://www.instagram.com/soumya.ghosh.33865/"
                    target="_blank"
                    rel="noreferrer"
                    title="Instagram"
                  >
                ...
                <div className="contact_address_link">
                  <a
                    href="https://www.linkedin.com/in/soumyadeep-ghosh-704a93289/"
                    target="_blank"
                    rel="noreferrer"
                    title="LinkedIn"
                  >
        ...
        <div className="From_contact">
          <div className="From_contact_us_heading">
            Have a question about resumes or need more help with your resume?
          </div>
          <div className="From_contact_us_heading2">
            ...
            <div className="From_contact_us">
              ...
              <div className="From_contact_us_right">
                <div className="From_contact_your_name">
                  <input
                    className="From_contact_your_name2"
                    placeholder="Name"
                    value={name}
                ...
                <div className="From_contact_your_email">
                  <input
                    className="From_contact_your_email2"
                    placeholder="E-Mail Address"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                  ></input>
                </div>
                <div className="From_contact_your_button">
                  <button
                    className="From_contact_your_button2"
        ...
        <div id="about_us" className="About_us">
          <div className="About_us_img">
            <img src={photo} alt="About_us_related" className="About_us_img2" />
          </div>
          <div className="About_us_contant">
            <div className="About_us_heading">About Us</div>
            <div className="About_us_contant2">
            ...
            <div className="About_us_contant_ul_parent">
              <ul className="About_us_ul">
                ...
                <li className="About_us_li">
                  Specialized resume templates and examples crafted by certified
                  resume writers
                </li>
                <li className="About_us_li">
            ...
            <div className="About_us_p_parent">
