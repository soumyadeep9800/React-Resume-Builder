  ...
  return (
    <div className={`resume-template_main_div ${fullScale ? "full-scale" : "small-scale"}`}>
      <div className={`resume-template ${fullScale ? "full-scale" : "small-scale"}`}>
        ...
        <section className="section_template1 resume-section">
          <h2>
            <FaUser /> Summary
          </h2>
          <p>{resume.summary}</p>
        ...
        <section className="section_template1 resume-section">
          ...
          {resume.education.map((edu, idx) => (
            <div key={idx} className="avoid-page-break">
              <p>
                <strong>{edu.university}</strong>
              </p>
              <p>
                {edu.department}, CGPA: {edu.cgpa}
              </p>
        ...
        <section className="section_template1 resume-section">
          <h2 className="section_template1_h2">
            <FaBriefcase /> Experience
          </h2>
          {resume.experience.map((job, idx) => (
            <div key={idx} className="job avoid-page-break">
              <p>
